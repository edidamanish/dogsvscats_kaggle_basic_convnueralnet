...
TRAIN_DIR = '/home/manish/Manish/Machine_Learning/Kaggle/DogvsCats/train'
TEST_DIR = '/home/manish/Manish/Machine_Learning/Kaggle/DogvsCats/test'
IMG_SIZE = 50
LR = 0.001

MODEL_NAME = 'dogsvscats-{}-{}.model'.format(LR, '6-conv-basic')
